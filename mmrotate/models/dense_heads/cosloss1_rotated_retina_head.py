...
class CosLoss1RRetinaHead(RotatedRetinaHead):
    ...
    def __init__(self,
        ...
        super(CosLoss1RRetinaHead, self).__init__(**kwargs, init_cfg=init_cfg)
    ...
    def _init_layers(self):
        ...
        super(CosLoss1RRetinaHead, self)._init_layers()
