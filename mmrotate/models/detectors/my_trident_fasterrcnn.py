...
class MyTridentFasterRCNN(RotatedFasterRCNN):
    """Implementation of `TridentNet <https://arxiv.org/abs/1901.01892>`_
    https://gitee.com/bernardlin/mmdet/blob/feature/wjlin/character_det/mmdet/models/detectors/trident_faster_rcnn.py#
    """
    ...
    def __init__(self,
        ...
        super(MyTridentFasterRCNN, self).__init__(
            backbone=backbone,
            neck=neck,
            rpn_head=rpn_head,
            roi_head=roi_head,
    ...
    def forward_train(self, img, img_metas, gt_bboxes, gt_labels, **kwargs):
        ...
        return super(MyTridentFasterRCNN,
