...
class MyNeck1(BaseModule):
    ...
    def __init__(self,
        ...
        super(MyNeck1, self).__init__(init_cfg)
    ...
    def forward(self, inputs):
        ...
        # myneck1 settings 增加空洞卷积
        outs = [
            self.dilated_encoder_blocks[i](self.fpn_convs[i](laterals[i])) for i in range(used_backbone_levels)
        ]
