...
class FPNSE_Conv(nn.Module):
    ...
    def forward(self, inputs):
        outputs = F.conv2d(inputs, self.w, self.w, bias=self.bias, stride=self.stride, padding=self.padding, dilation=self.dilation)
