...
CUDA_VISIBLE_DEVICES=3 OMP_NUM_THREADS=0 python ./tools/test.py configs/myexps/tridentnet_exp3.py ./work_dirs/tridentnet_exp3/epoch_12.pth --format-only --eval-options submission_dir=work_dirs/Task1_results_tridentnet_exp3_1024
